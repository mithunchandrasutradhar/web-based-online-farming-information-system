			...
			<div id="right-section">
			   ...
			   <div class="containers">
				<form action="submit.php" method="post" >
					...
					<div class="row">
					  <div class="col-25">
						<label for="idno">জাতীয় পরিচয়পত্র নম্বর -</label>
					  </div>
					  <div class="col-75">
					...
					<div class="row">
						...
						<div class="col-75">
						   <input type="radio" name="gender" value="পুরুষ" required> পুরুষ
						   <input type="radio" name="gender" value=" মহিলা " required> মহিলা 
						</div>
					</div>
					...
					<div class="row">
						<div class="col-25">
							<label for="contact_number">মোবাইল নং -</label>
						</div>
					...
					<div class="row">
						...
						<div class="col-75">
						   <input type="password" class="text" value="" id="myInput" name="password" required><br>
					...
					<div class="row">
						<div class="col-75">
						   <input type="checkbox" name="something" value="gdgdgdf" required> উপরে বর্ণিত সকল তথ্য সত্য । 
						</div>
					</div>
					<br>
					<br>
					<div class="row">
					  <input type="submit" value="সাব-মিট">
					</div>
				</form>
			</div>
			</div>
